...
from tools.losses.joint_loss import *
from tools.losses.soft_ce import *
from tools.losses.dice import *
from tools.losses.functional import *
...
weights_path = "models/ckpt/"
test_weights_name = "abcnet-512-crop-ms-e200"
log_name = 'Urban/{}'.format(weights_name)
monitor = 'val_OA'
monitor_mode = 'max'
save_top_k = 1
save_last = False
check_val_every_n_epoch = 1
pretrained_ckpt_path = 'models/ckpt/' # the path for the pretrained model weight
...
# Datasets
train_data_root = 'data/Urban/train' 
val_data_root = 'data/Urban/val' 
